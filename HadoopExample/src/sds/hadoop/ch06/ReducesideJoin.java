...
public class ReducesideJoin extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		// MultipleInputs 설정
		MultipleInputs.addInputPath(job, new Path(otherArgs[0]), TextInputFormat.class, ItemMapper.class);
		MultipleInputs.addInputPath(job, new Path(otherArgs[1]), TextInputFormat.class, ReducesideJoinMapper.class);
